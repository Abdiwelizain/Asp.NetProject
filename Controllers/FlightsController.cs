...
namespace Airline_Reservation_System.Controllers
{
    public class FlightsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FlightID,AirlineName")] Flights flights)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FlightID,AirlineName")] Flights flights)
        {
